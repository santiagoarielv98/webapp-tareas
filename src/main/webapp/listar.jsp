...
<table class="table table-hover table-striped">
    ...
    <%--@elvariable id="cursos" type="java.util.List"--%>
    <c:forEach items="${cursos}" var="c">
        <tr>
            ...
            <td>${c.instructor}</td>
            <td>${c.duracion}</td>
            <td><a href="${pageContext.request.contextPath}/cursos/form${"?id="}${c.id}" class="btn btn-sm btn-success">editar</a>
            </td>
            <td><a onclick="return confirm('esta seguro que desea eliminar?');"
                   href="${pageContext.request.contextPath}/cursos/eliminar${"?id="}${c.id}"
